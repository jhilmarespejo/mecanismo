...
<script>
    ...
    //Al seleccionar una SUBcategoria se cargan en pantalla las sus preguntas correspondientes
    $(document).on('change', '.cbo-subCategoria', function () {
        ...
        $.ajax({
                ...
                beforeSend: function () {  },
                success: function (data, response) {
                    $("#preguntas_subcategoria_"+ids[0]+"_"+ids[1]).append(data);
                    //$('#card_body_'+ids[0]).append(data);
                },
                error: function(response){ }
            });
    });
